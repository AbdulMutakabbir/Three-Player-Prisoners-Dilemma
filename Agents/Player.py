class Player(object):
    """
    This defines an interface for a player of the 2-player.  Inherit and modify this class
    ...
    def play(self, myHistory, oppHistory0, oppHistory2):
        ...
        ( -1 = cooperate; 1 = defect )
        myHistory = list of int representing your past plays
        oppHisotry0 = list of int representing opponent 1's past plays
        oppHisotry1 = list of int representing opponent 2's past plays
